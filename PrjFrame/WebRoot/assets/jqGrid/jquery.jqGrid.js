...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			var sep = "<td class='ui-pg-button "+disabled+"'></td>",/*<span class='ui-separator'></span>*/
			pginp = "",
	...
	navGrid : function (elem, p, pEdit, pAdd, pDel, pSearch, pView) {
		...
		return this.each(function() {
			...
			for(i = 0; i<clone; i++) {
				...
				sep = "<td class='ui-pg-button " +commonstyle.disabled + "' style='width:4px;'></td>",/* yyh <span class='ui-separator'></span>*/
				pgid, elemids;
				if(i===0) {
					pgid = elem;
					elemids = $t.p.id;
